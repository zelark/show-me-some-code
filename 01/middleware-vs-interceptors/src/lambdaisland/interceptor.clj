(ns lambdaisland.interceptor
  ...
  For real-world implementations have a look
  at [pedestal.interceptor](http://pedestal.io/guides/what-is-an-interceptor),
  [re-frame interceptors](https://github.com/Day8/re-frame/blob/master/docs/Interceptors.md),
  and [Sieppari](https://github.com/metosin/sieppari).
...
(defn into-queue
  ...
  ([xs]
   (into-queue nil xs))
  ([q xs]
   ((fnil into clojure.lang.PersistentQueue/EMPTY) q xs)))
